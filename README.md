...
# Plateforme Data Cloud – Randstad Digital Lille

## Présentation du Projet

Ce projet consiste à concevoir et mettre en place une plateforme Data Cloud moderne pour Randstad Digital Lille afin de centraliser, transformer, stocker et exploiter efficacement les données provenant de plusieurs sources métiers.
